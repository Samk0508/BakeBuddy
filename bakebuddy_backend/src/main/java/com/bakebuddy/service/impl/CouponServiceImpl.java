...
public class CouponServiceImpl implements CouponService {
    ...
    @Override
    public Cart applyCoupon(String code,double orderValue,User user)throws CouponNotValidException {
...
//                return cart;
    ...
    @Override
    public Cart removeCoupon(String code, User user) throws CouponNotValidException {
        Coupon coupon = couponRepository.findByCode(code);
